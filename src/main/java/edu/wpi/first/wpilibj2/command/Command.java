 ...
 * run by the {@link SimpleCmdScheduler}, and can be composed into CommandGroups to allow users to
...
public interface Command {
  ...
  default void schedule(boolean interruptible) {
    SimpleCmdScheduler.getInstance().schedule(interruptible, this);
  }
   ...
   */
  default void cancel() {
    SimpleCmdScheduler.getInstance().cancel(this);
  }
  ...
  default boolean isScheduled() {
    return SimpleCmdScheduler.getInstance().isScheduled(this);
  }
  ...
  /*
   * These have been copied from the Sendable interface to remove the dependency.
   * Network tables and Smart Dashboard are not available in FTC
   */
