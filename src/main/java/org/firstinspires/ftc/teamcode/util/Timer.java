...
public class Timer {
  private static double m_matchStartTime = currentTimeMillis();
   ...
   */
  // TODO: Convert to FTC if possible
  public static double getMatchTime() {
    // Just go with a 150 second match for now
    return (m_matchStartTime + 150000.0 - currentTimeMillis()) / 1000.0;
  }
