 ...
 * {@link SimpleCmdScheduler}'s resource management system to ensure multiple robot actions are not
 ...
 * {@link SimpleCmdScheduler#registerSubsystem(Subsystem...)} method in order for the
...
public interface Subsystem {
  ...
  /**
   * This method is called periodically by the {@link SimpleCmdScheduler}.  Useful for updating
  ...
  default void setDefaultCommand(Command defaultCommand) {
    SimpleCmdScheduler.getInstance().setDefaultCommand(this, defaultCommand);
  }
  ...
  default Command getDefaultCommand() {
    return SimpleCmdScheduler.getInstance().getDefaultCommand(this);
  }
  ...
  default Command getCurrentCommand() {
    return SimpleCmdScheduler.getInstance().requiring(this);
  }

  /**
   * Registers this subsystem with the {@link SimpleCmdScheduler}, allowing its
