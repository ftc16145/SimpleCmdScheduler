...
package org.firstinspires.ftc.teamcode.command.button;

import java.util.function.BooleanSupplier;

import org.firstinspires.ftc.teamcode.command.Command;
import org.firstinspires.ftc.teamcode.command.SimpleCmdScheduler;
...
public class Trigger {
  ...
  public Trigger whenActive(final Command command, boolean interruptible) {
    ...
    SimpleCmdScheduler.getInstance().addButton(new Runnable() {
